...
public class PrintPossibleWords {
    ...
    private static void searchWord(TrieNode root, boolean[] hash, String str) {
        // if we found word in algo.practice.old.trie / dictionary
        if (root.isEndOfTheWord) System.out.println(str);
        ...
        for (int K = 0; K < SIZE; K++) {
            if (hash[K] && root.children[K] != null) {
                ...
                // of word in algo.practice.old.trie
    ...
    private static void printAllWords(char[] arr, TrieNode root, int n) {
        ...
        for (int i = 0; i < n; i++) Hash[arr[i] - 'a'] = true;
    ...
    public static void main(String[] args) {
        ...
        // insert all words of dictionary into algo.practice.old.trie
